...
public class Car extends Vehicle {
	...
	public void refuel(int amountOfGas) {
		...
		if(amountOfGas + super.gasRemained > this.maxGasAmountInTank)
      super.gasRemained = this.maxGasAmountInTank;
    else
      super.gasRemained += amountOfGas;
	}
	...
	public void run(int hour) {
		...
		//TODO Implement method
		if(super.gasRemained <= 0)
      System.out.println("Gas out! Please add fuel!");
    else
    {
      int gasConsumed = hour * this.gasConsumedPerHour;
      super.totalGasConsumed += Math.min(super.gasRemained, gasConsumed);

      if(super.gasRemained - gasConsumed <= 0)
      {
